...
# Helper functions for convolution layers
...
# ResNet Bottleneck with SENet block
class SEBottleneck(nn.Module):
    ...
    def __init__(
        ...
        # SENet block
        self.se_block = SEBlock(width, reduction=se_reduction)
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        # Apply SENet block after penultimate conv block
...
class CBAMBottleneck(nn.Module):
    ...
    def __init__(
        ...
        # CBAM block
        self.cbam = CBAM(width, reduction=cbam_reduction, kernel_size=cbam_kernel_size)
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        # Apply CBAM block after penultimate conv block
        out = self.cbam(out)
...
def wide_resnet50_2_senet(pretrained: bool = False, progress: bool = True, **kwargs: Any) :
    r"""Wide ResNet-50-2 model from
    `"Wide Residual Networks" <https://arxiv.org/pdf/1605.07146.pdf>`_.
...
def wide_resnet50_2_cbam(pretrained: bool = False, progress: bool = True, **kwargs: Any) :
    r"""Wide ResNet-50-2 model from
    `"Wide Residual Networks" <https://arxiv.org/pdf/1605.07146.pdf>`_.
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _resnet('wide_resnet50_2', CBAMBottleneck, [3, 4, 6, 3],
                   pretrained, progress, **kwargs)

"""Normalizing-flow primitives extracted from the FrEIA framework.

Source: https://github.com/VLL-HD/FrEIA

This is a trimmed assembly of only the modules and functions DifferNet needs:
the reversible graph network, permutation layers, GLOW-style affine coupling
blocks and the fully connected subnetwork used inside them. Vendoring them
avoids a hard dependency on the full FrEIA package.
"""

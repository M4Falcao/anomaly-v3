"""Evaluate one checkpoint and dump per-image scores, metrics and plots.

Reports image-level and pixel-level metrics for a single model file, including
the system cost (latency, RAM/VRAM) of inference.

Usage:
    python scripts/eval/test_single_checkpoint.py --help
"""

"""Step-by-step visualization of CAM faithfulness metrics.

Renders the Deletion/Insertion perturbation steps produced by GradCAM for a
trained model and plots the anomaly-score decay curve as the most relevant
pixels are progressively removed.

Usage:
    python scripts/eval/visualize_cam_metric_steps.py --model_path <model.pt> --index 0 --steps 5
"""
import os

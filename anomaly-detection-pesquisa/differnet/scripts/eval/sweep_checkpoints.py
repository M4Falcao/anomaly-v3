"""Sweep every checkpoint in a folder and compare them side by side.

Evaluates each ``.pt`` file found under the given directory, collects image and
pixel metrics plus system cost, and writes a comparative CSV and plots.

Usage:
    python scripts/eval/sweep_checkpoints.py --help
"""
...
import config as c
from core.utils import load_datasets, preprocess_batch, get_loss, t2np, make_dataloaders
from core.model import DifferNet, SEDifferNet, CBAMDifferNet, load_weights
from core.eval_common import (
    ARCH_MAP,
    calculate_pg2,
    calculate_pixel_level_metrics,
    get_grad_maps,
    get_optimal_metrics,
    get_system_metrics,
    load_architecture_from_group,
)
...
# --- Metric, gradient and architecture helpers live in core.eval_common ---

"""CAM sanity check via cascading weight randomization.

Randomizes the normalizing-flow head of a trained model and measures the
Spearman rank correlation between the GradCAM heatmaps of the trained and the
randomized model, verifying the explanations reflect learned weights.

Usage:
    python scripts/eval/evaluate_cam_sanity_check.py --model_path <model.pt> --class_name <class>
"""
import os
...
def evaluate_cam_sanity_check(model_name, model_path, dataset_path, class_name, output_dir, limit=None):

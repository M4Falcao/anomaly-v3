...
def safe_torch_save(obj, target_path, retries=2):
    ...
    Falls back to legacy serialization on failure to avoid Zip writer errors.
    ...
    for attempt in range(retries + 1):
        try:
            # Default serialization (zipfile format)
            ...
            # Retry with legacy format once before giving up on this attempt.
            try:
